  ...
  return (
    <nav className="bg-gray-900 text-white px-6 py-6 flex items-center justify-between shadow-md transition-colors duration-300 fixed top-0 left-0 w-full z-50">
      ...
      <ul className="flex space-x-6 items-center">
        ...
        <li>
          <a href="#events" className="hover:text-orange-400 transition-colors duration-300">
            Highlights
          </a>
        </li>
        <li>
          <a href="#Review" className="hover:text-orange-400 transition-colors duration-300">
            Review
          </a>
        </li>
        ...
        <li>
          <a href="#session" className="hover:text-orange-400 transition-colors duration-300">
            Session
          </a>
        </li>
        <li
