...
const AchievementCarousel = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-black via-gray-900 to-black px-4 pt-24 pb-12 overflow-hidden">
      ...
      <div className="relative w-full max-w-7xl h-[440px] sm:h-[420px] mx-auto flex items-center justify-center">
        ...
        <button
          onClick={handlePrev}
          className="absolute top-1/2 left-2 sm:left-4 -translate-y-1/2 text-orange-600 bg-white/10 hover:bg-white/20 backdrop-blur p-2 sm:p-3 rounded-full z-50"
        >
        ...
        <button
          onClick={handleNext}
          className="absolute top-1/2 right-2 sm:right-4 -translate-y-1/2 text-orange-600 bg-white/10 hover:bg-white/20 backdrop-blur p-2 sm:p-3 rounded-full z-50"
        >
